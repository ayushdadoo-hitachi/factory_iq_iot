...
STAGE1_TABLE = f"`{CATALOG}`.`{SCHEMA}`.{cfg['tables']['stage1']}{'_'}{ROBOT_DATA}"
STAGE2_TABLE = f"`{CATALOG}`.`{SCHEMA}`.{cfg['tables']['stage2']}{'_'}{ROBOT_DATA}"
STAGE3_TABLE = f"`{CATALOG}`.`{SCHEMA}`.{cfg['tables']['stage3']}{'_'}{ROBOT_DATA}"
STAGE4_TABLE = f"`{CATALOG}`.`{SCHEMA}`.{cfg['tables']['stage4']}{'_'}{ROBOT_DATA}"
STAGE5_TABLE = f"`{CATALOG}`.`{SCHEMA}`.{cfg['tables']['stage5']}{'_'}{ROBOT_DATA}"
